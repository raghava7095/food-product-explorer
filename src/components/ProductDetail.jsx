...
function ProductDetail() {
  ...
  if (!product) {
    return <p className="text-center text-red-600 text-lg font-semibold">Product not found</p>;
  }
    ...
    <div className="max-w-7xl mx-auto p-6 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row gap-8 bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition duration-300">
        ...
        <div className="md:w-2/3 flex flex-col gap-4">
          ...
          <div className="mt-4">
            <h2 className="text-2xl font-semibold text-gray-800">Nutritional Info</h2>
